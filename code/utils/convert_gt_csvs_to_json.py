...
def main(dataset_root_path, subset="train"):
    ...
    assert os.path.exists("/ssd/lizhaoyang/code/neurips22-cellseg_saltfish/data/cell/csv_label")
    gt_paths = sorted(glob.glob("/ssd/lizhaoyang/code/neurips22-cellseg_saltfish/data/cell/csv_label/*.csv"))
